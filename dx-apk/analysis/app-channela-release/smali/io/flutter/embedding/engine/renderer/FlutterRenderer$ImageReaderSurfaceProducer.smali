...
.field private lastReaderDequeuedFrom:Lio/flutter/embedding/engine/renderer/d;
...
.field final synthetic this$0:Lio/flutter/embedding/engine/renderer/e;


# direct methods
.method public constructor <init>(Lio/flutter/embedding/engine/renderer/e;J)V
    .locals 2

    .line 1
    iput-object p1, p0, Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer;->this$0:Lio/flutter/embedding/engine/renderer/e;
    ...
    .line 57
    iput-object p1, p0, Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer;->lastReaderDequeuedFrom:Lio/flutter/embedding/engine/renderer/d;

    .line 58
    .line 59
    iput-object p1, p0, Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer;->callback:LA7/t;
...
.method public static synthetic access$400(Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer;)Lio/flutter/embedding/engine/renderer/d;
    .locals 0

    .line 1
    iget-object p0, p0, Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer;->lastReaderDequeuedFrom:Lio/flutter/embedding/engine/renderer/d;
...
.method private cleanup()V
    ...
    .line 27
    .line 28
    iget-object v5, p0, Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer;->lastReaderDequeuedFrom:Lio/flutter/embedding/engine/renderer/d;
    ...
    .line 31
    .line 32
    iput-object v4, p0, Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer;->lastReaderDequeuedFrom:Lio/flutter/embedding/engine/renderer/d;
    ...
    :cond_0
    :goto_1
    iput-boolean v3, v2, Lio/flutter/embedding/engine/renderer/d;->c:Z

    .line 38
    .line 39
    iget-object v3, v2, Lio/flutter/embedding/engine/renderer/d;->a:Landroid/media/ImageReader;
    ...
    .line 43
    .line 44
    iget-object v2, v2, Lio/flutter/embedding/engine/renderer/d;->b:Ljava/util/ArrayDeque;
    ...
    .line 80
    .line 81
    iget-object v2, v2, Lio/flutter/embedding/engine/renderer/b;->a:Landroid/media/Image;
    ...
    .line 92
    :cond_3
    iget-object v1, p0, Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer;->lastReaderDequeuedFrom:Lio/flutter/embedding/engine/renderer/d;
    ...
    .line 95
    .line 96
    iput-boolean v3, v1, Lio/flutter/embedding/engine/renderer/d;->c:Z

    .line 97
    .line 98
    iget-object v2, v1, Lio/flutter/embedding/engine/renderer/d;->a:Landroid/media/ImageReader;
    ...
    .line 102
    .line 103
    iget-object v1, v1, Lio/flutter/embedding/engine/renderer/d;->b:Ljava/util/ArrayDeque;
...
.method private createImageReader29()Landroid/media/ImageReader;
    ...
    .line 4
    .line 5
    invoke-static {v0, v1}, Le6/a;->h(II)Landroid/media/ImageReader;
...
.method private createImageReader33()Landroid/media/ImageReader;
    ...
    .line 7
    .line 8
    invoke-static {v0, v1}, LD/f0;->j(II)Landroid/media/ImageReader$Builder;
    ...
    .line 12
    invoke-static {v0}, LD/f0;->u(Landroid/media/ImageReader$Builder;)V

    .line 13
    .line 14
    .line 15
    invoke-static {v0}, LD/f0;->C(Landroid/media/ImageReader$Builder;)V

    .line 16
    .line 17
    .line 18
    invoke-static {v0}, LD/f0;->D(Landroid/media/ImageReader$Builder;)V

    .line 19
    .line 20
    .line 21
    invoke-static {v0}, LD/f0;->k(Landroid/media/ImageReader$Builder;)Landroid/media/ImageReader;
...
.method private getActiveReader()Lio/flutter/embedding/engine/renderer/d;
    .locals 3
    ...
    .line 39
    invoke-direct {p0, v1}, Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer;->getOrCreatePerImageReader(Landroid/media/ImageReader;)Lio/flutter/embedding/engine/renderer/d;
...
.method private getOrCreatePerImageReader(Landroid/media/ImageReader;)Lio/flutter/embedding/engine/renderer/d;
    .locals 2
    ...
    .line 10
    .line 11
    invoke-virtual {p0, p1}, Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer;->createPerImageReader(Landroid/media/ImageReader;)Lio/flutter/embedding/engine/renderer/d;
...
.method private lambda$dequeueImage$0()V
    ...
    .line 4
    .line 5
    iget-object v0, p0, Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer;->this$0:Lio/flutter/embedding/engine/renderer/e;
...
.method private releaseInternal()V
    ...
    .line 13
    .line 14
    iget-object v0, v0, Lio/flutter/embedding/engine/renderer/e;->g:Ljava/util/ArrayList;
...
.method private waitOnFence(Landroid/media/Image;)V
    ...
    .line 1
    :try_start_0
    invoke-static {p1}, LD/f0;->g(Landroid/media/Image;)Landroid/hardware/SyncFence;
    ...
    .line 5
    invoke-static {p1}, LD/f0;->t(Landroid/hardware/SyncFence;)V
    :try_end_0
...
.method public acquireLatestImage()Landroid/media/Image;
    ...
    .line 1
    invoke-virtual {p0}, Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer;->dequeueImage()Lio/flutter/embedding/engine/renderer/b;
    ...
    .line 9
    :cond_0
    iget-object v0, v0, Lio/flutter/embedding/engine/renderer/b;->a:Landroid/media/Image;
...
.method public createPerImageReader(Landroid/media/ImageReader;)Lio/flutter/embedding/engine/renderer/d;
    .locals 1
    ...
    .line 2
    .line 3
    invoke-direct {v0, p0, p1}, Lio/flutter/embedding/engine/renderer/d;-><init>(Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer;Landroid/media/ImageReader;)V
...
.method public dequeueImage()Lio/flutter/embedding/engine/renderer/b;
    .locals 7
    ...
    .line 23
    check-cast v3, Lio/flutter/embedding/engine/renderer/d;

    .line 24
    .line 25
    iget-object v4, v3, Lio/flutter/embedding/engine/renderer/d;->b:Ljava/util/ArrayDeque;
    ...
    .line 39
    check-cast v4, Lio/flutter/embedding/engine/renderer/b;
    ...
    .line 61
    .line 62
    iget-object v1, v1, Lio/flutter/embedding/engine/renderer/b;->a:Landroid/media/Image;
    ...
    .line 74
    .line 75
    iput-object v3, p0, Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer;->lastReaderDequeuedFrom:Lio/flutter/embedding/engine/renderer/d;
    ...
    .line 112
    .line 113
    iget-object v0, v0, Lio/flutter/embedding/engine/renderer/e;->e:Landroid/os/Handler;
...
.method public getSurface()Landroid/view/Surface;
    ...
    .line 1
    invoke-direct {p0}, Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer;->getActiveReader()Lio/flutter/embedding/engine/renderer/d;
...
.method public numImages()I
    ...
    .line 22
    .line 23
    iget-object v3, v3, Lio/flutter/embedding/engine/renderer/d;->b:Ljava/util/ArrayDeque;
...
.method public onImage(Landroid/media/ImageReader;Landroid/media/Image;)V
    ...
    .line 4
    :try_start_0
    invoke-direct {p0, p1}, Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer;->getOrCreatePerImageReader(Landroid/media/ImageReader;)Lio/flutter/embedding/engine/renderer/d;
    ...
    .line 8
    iget-boolean v1, p1, Lio/flutter/embedding/engine/renderer/d;->c:Z
    ...
    .line 15
    .line 16
    iget-object v2, p1, Lio/flutter/embedding/engine/renderer/d;->d:Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer;
    ...
    .line 20
    .line 21
    invoke-direct {v1, v2, p2}, Lio/flutter/embedding/engine/renderer/b;-><init>(Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer;Landroid/media/Image;)V

    .line 22
    .line 23
    .line 24
    iget-object p1, p1, Lio/flutter/embedding/engine/renderer/d;->b:Ljava/util/ArrayDeque;
    ...
    .line 40
    check-cast p2, Lio/flutter/embedding/engine/renderer/b;

    .line 41
    .line 42
    iget-object p2, p2, Lio/flutter/embedding/engine/renderer/b;->a:Landroid/media/Image;
    ...
    .line 53
    :cond_2
    iget-object p1, p0, Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer;->this$0:Lio/flutter/embedding/engine/renderer/e;

    .line 54
    .line 55
    iget-object p1, p1, Lio/flutter/embedding/engine/renderer/e;->a:Lio/flutter/embedding/engine/FlutterJNI;
...
.method public onTrimMemory(I)V
    ...
    .line 16
    iget-object p1, p0, Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer;->callback:LA7/t;
    ...
    .line 23
    .line 24
    iget-object v0, p1, Lv7/r;->d:LY0/r;
    ...
    .line 29
    invoke-virtual {v0, v2}, LY0/F;->a0(Landroid/view/Surface;)V

    .line 30
    .line 31
    .line 32
    iput-boolean v1, p1, Lx7/b;->e:Z
...
.method public pruneImageReaderQueue()V
    ...
    .line 19
    .line 20
    iget-object v2, v0, Lio/flutter/embedding/engine/renderer/d;->b:Ljava/util/ArrayDeque;
    ...
    .line 27
    .line 28
    iget-object v3, v0, Lio/flutter/embedding/engine/renderer/d;->d:Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer;

    .line 29
    .line 30
    invoke-static {v3}, Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer;->access$400(Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer;)Lio/flutter/embedding/engine/renderer/d;
    ...
    .line 42
    .line 43
    iget-object v4, v0, Lio/flutter/embedding/engine/renderer/d;->a:Landroid/media/ImageReader;
    ...
    .line 47
    .line 48
    iput-boolean v1, v0, Lio/flutter/embedding/engine/renderer/d;->c:Z
...
.method public setCallback(LA7/t;)V
    .locals 0

...
.method public static appIsLibraryForComposePreview(Landroid/content/Context;)Z
    ...
    .line 45
    invoke-static {v0}, Le6/a;->d(Landroid/app/ActivityManager$RecentTaskInfo;)Landroid/content/Intent;
...
.method public static getPackageInfo(Landroid/content/Context;ILio/sentry/ILogger;Lio/sentry/android/core/BuildInfoProvider;)Landroid/content/pm/PackageInfo;
    ...
    invoke-static {v0, v1}, LD/f0;->e(J)Landroid/content/pm/PackageManager$PackageInfoFlags;

    move-result-object p1

    invoke-static {p3, p0, p1}, LD/f0;->b(Landroid/content/pm/PackageManager;Ljava/lang/String;Landroid/content/pm/PackageManager$PackageInfoFlags;)Landroid/content/pm/PackageInfo;
...
.method private static synthetic lambda$static$3(Landroid/content/Context;)Landroid/content/pm/ApplicationInfo;
    ...
    .line 13
    invoke-static {v0, p0, v1}, LD/f0;->a(Landroid/content/pm/PackageManager;Ljava/lang/String;Landroid/content/pm/PackageManager$ApplicationInfoFlags;)Landroid/content/pm/ApplicationInfo;
...
.method public static registerReceiver(Landroid/content/Context;Lio/sentry/android/core/BuildInfoProvider;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Landroid/os/Handler;)Landroid/content/Intent;
    ...
    .line 5
    invoke-static {p0, p2, p3, p4}, LY2/a;->i(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Landroid/os/Handler;)Landroid/content/Intent;

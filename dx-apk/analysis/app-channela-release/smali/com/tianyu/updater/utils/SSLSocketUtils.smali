.class public Lcom/tianyu/updater/utils/SSLSocketUtils;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/tianyu/updater/utils/SSLSocketUtils$TrustAllHostnameVerifier;
    }
.end annotation
...
.method public static createSSLSocketFactory(Landroid/content/Context;I)Ljavax/net/ssl/SSLSocketFactory;
    ...
    invoke-static {p0}, Lcom/tianyu/updater/utils/SSLSocketUtils;->createSSLSocketFactory([Ljava/io/InputStream;)Ljavax/net/ssl/SSLSocketFactory;
...
.method public static varargs createSSLSocketFactory([Ljava/io/InputStream;)Ljavax/net/ssl/SSLSocketFactory;
    ...
    .line 6
    const-class v0, Lcom/tianyu/updater/utils/SSLSocketUtils;
    ...
    .line 8
    :try_start_1
    invoke-static {p0}, Lcom/tianyu/updater/utils/SSLSocketUtils;->getTurstManager([Ljava/io/InputStream;)[Ljavax/net/ssl/TrustManager;
...
.method public static createTrustAllHostnameVerifier()Lcom/tianyu/updater/utils/SSLSocketUtils$TrustAllHostnameVerifier;
    .locals 1

    .line 1
    new-instance v0, Lcom/tianyu/updater/utils/SSLSocketUtils$TrustAllHostnameVerifier;

    .line 2
    .line 3
    invoke-direct {v0}, Lcom/tianyu/updater/utils/SSLSocketUtils$TrustAllHostnameVerifier;-><init>()V
...
.method public static createTrustAllManager()Ljavax/net/ssl/X509TrustManager;
    ...
    .line 1
    :try_start_0
    new-instance v0, Lcom/tianyu/updater/utils/SSLSocketUtils$1;

    .line 2
    .line 3
    invoke-direct {v0}, Lcom/tianyu/updater/utils/SSLSocketUtils$1;-><init>()V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static varargs getTurstManager([Ljava/io/InputStream;)[Ljavax/net/ssl/TrustManager;
    ...
    .line 79
    .line 80
    invoke-static {}, Lcom/tianyu/updater/utils/SSLSocketUtils;->getTurstAllManager()[Ljavax/net/ssl/TrustManager;
